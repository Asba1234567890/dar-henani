-- Add a completed state for fully paid event reservations.
ALTER TYPE "ReservationStatus" ADD VALUE 'COMPLETED';

-- Automatically mark EVENT reservations as COMPLETED when their payments
-- reach the full reservation total.
...
-- Also complete any existing event reservations that are already fully paid.
